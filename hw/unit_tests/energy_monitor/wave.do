...
add wave -noupdate -radix decimal {/tb_energy_monitor/dut/partial_energy_calc_inst[1]/u_partial_energy_calc/energy_local_wo_hbias}
...
WaveRestoreCursors {{Cursor 1} {247905 ps} 0}
...
update
WaveRestoreZoom {242145 ps} {251276 ps}
